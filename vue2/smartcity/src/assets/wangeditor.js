    ...
    emotions: [
        {
            ...
            content: [{
                alt: '[害羞]',
                src: 'http://img.mp.itc.cn/upload/20170811/c09e1422633d4add88e7b6f412cd4fcd.jpg'
            }, {
                alt: '[笑脸]',
                src: 'http://img.mp.itc.cn/upload/20170811/a5b70586c8ad4c86a29a68c52b15aa3d.jpg'
            }, {
                alt: '[色]',
                src: 'http://img.mp.itc.cn/upload/20170811/bdcd9b3db16d4046ae0356f47746c4d4.jpg'
            },
            {
                alt: '[难受]',
                src: 'http://img.mp.itc.cn/upload/20170811/2021b4deb9df492395ab088a89d3be53.jpg'
            },
            {
                alt: '[委屈]',
                src: 'http://img.mp.itc.cn/upload/20170811/e8025de758ac440fa60f7c6d937c5356.jpg'
            },
            {
                alt: '[挠痒痒]',
                src: 'http://img.mp.itc.cn/upload/20170811/14b1b7892ab14530b9ed595176304146.jpg'
            },
            {
                alt: '[笑]',
                src: 'http://img.mp.itc.cn/upload/20170811/1c7ca7621ffb4ffc993a3c67aaa185a3.jpg'
            },
            {
                alt: '[一撇]',
                src: 'http://img.mp.itc.cn/upload/20170811/1ff2242d25ba42cfb9c56d369e269a3c.jpg'
            },
            {
                alt: '[可爱]',
                src: 'http://img.mp.itc.cn/upload/20170811/5204847dd4f044c0aeb32489f0532216.jpg'
            },
            {
                alt: '[天使]',
                src: 'http://img.mp.itc.cn/upload/20170811/e253675fa54a4595bd74283d5140d9ed.jpg'
            },
            {
                alt: '[笑哭]',
                src: 'http://img.mp.itc.cn/upload/20170811/7ad0d4e892ae40648c9f302ce7bf2d39.jpg'
            },
            {
                alt: '[哼]',
                src: 'http://img.mp.itc.cn/upload/20170811/5ac1581f33f5407b94b59a63f9d63eb4.jpg'
            },
            {
                alt: '[呀]',
                src: 'http://img.mp.itc.cn/upload/20170811/0f51d4e901d74e0c8b2187acd180f023.jpg'
            },
            {
                alt: '[吐舌]',
                src: 'http://img.mp.itc.cn/upload/20170811/ea3cf7cfb17e44d9977a0415cda0c0ac.jpg'
            },
            {
                alt: '[嫌弃]',
                src: 'http://img.mp.itc.cn/upload/20170811/118cb053e6cf40bd8ab715773907a964.jpg'
            },
            {
                alt: '[生气]',
                src: 'http://img.mp.itc.cn/upload/20170811/ee2a3756883940b09398636206283235.jpg'
            },
            {
                alt: '[惊]',
                src: 'http://img.mp.itc.cn/upload/20170811/79ac5c2824c346d2a00aa1dae49d7bf4.jpg'
            },
        ]
        },
    ],
            ...
            if (emotType === 'image') {
                content.forEach(function (item) {
                    ...
                    if (src) {
                        ...
                        faceHtml += '<span class="w-e-item"><img class="bq-image" src="' + src + '" alt="' + alt + '" data-w-e="1"/></span>';
                    }
                });
            }
...
Video.prototype = {
    ...
    _createPanel: function _createPanel() {
            ...
            /* {
                ...
                events: [{
                    ...
                    fn: function fn() {
                        ...
                        if (val){
                            _this._insert(val)
                            // if(new RegExp("^<iframe").test(val)){
                            //     _this._insert(val)
                            // } else{
                            //     _this._insert(`<video src=${val}/>`)
                            // }
                        }; // 插入视频
                        // 返回 true，表示该事件执行完之后，panel 要关闭。否则 panel 不会关闭
                        return true;
        ...
        if (config.uploadVideoServer) {
            // 显示“上传视频”
            tabsConfigResult.push(tabsConfig[0],tabsConfig[1]);
        }
...
UploadImg.prototype = {
    ...
    insertLinkVideo: function insertLinkVideo(link) {
        ...
        editor.cmd.do('insertHTML', '<video src="' + link + '" style="width:100%;" controls autobuffer autoplay muted x5-video-player-type="h5" x5-video-player-fullscreen="true" playsinline webkit-playsinline/>');
    }
};
